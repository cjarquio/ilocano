...
import { sectionTypes } from "../Lesson/lessonNames";
...
const ReturnLesson: React.FC<LsiRouterProps> = (props: LsiRouterProps) => {
  ...
  switch (currentSection) {
    ...
    case sectionTypes[sectionTypes.translatingthedialog]:
      return (
        <Lesson currentSection={currentSection} lessonData={lessonData}>
          <TranslatingDialogSection dialog={lessonData.dialog} />
        </Lesson>
      );
    default:
      return <NoMatch />;
...
export const LsiRouter: React.FC<LsiRouterProps> = (props: LsiRouterProps) => {
  ...
  return (
    <Routes>
      ...
      <Route
        path="/:currentLesson/:currentSection"
        element={<ReturnLesson lessonData={lessonData} />}
      />
